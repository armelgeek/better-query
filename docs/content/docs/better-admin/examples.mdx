...
Complete examples demonstrating how to build admin interfaces with better-auth and better-query.

## Quick Start Example

A minimal admin interface with authentication and CRUD operations.
