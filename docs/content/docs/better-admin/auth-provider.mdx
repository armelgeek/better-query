...
Better Admin uses **better-auth** for authentication instead of ra-core. This provides a flexible, type-safe authentication system that works seamlessly with your admin interface.
