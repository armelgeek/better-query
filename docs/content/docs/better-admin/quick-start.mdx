...
<Callout type="info">
**Using a different database?** Better Auth supports PostgreSQL, MySQL, and other databases. Check the [Better Auth docs](https://better-auth.dev) for other database options.
</Callout>
