...
- **Better Auth Plugin**: Seamless integration with Better Auth for authentication and role-based permissions
...
import { auditPlugin, cachePlugin } from "better-call";
...
The Better Auth plugin provides seamless integration with Better Auth, offering authentication, user context, and role-based permissions.

```ts title="lib/query.ts"
import { betterQuery } from "better-query";
import { betterAuth } from "better-query/plugins";
...
**Features:**
- Automatic user context extraction from Better Auth sessions
- Role-based permissions with resource and operation filtering
- Type-safe user context in permission functions
- Support for custom user extraction functions
- Session validation and management

**Helper Functions:**

Use the `createBetterAuthContext` helper for type-safe user operations:

```ts
import { createBetterAuthContext } from "better-query/plugins";
