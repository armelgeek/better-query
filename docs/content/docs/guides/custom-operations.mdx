...
For a complete working example with all custom operations, see the [custom operations demo](https://github.com/armelgeek/better-kit/blob/main/packages/better-query/examples/custom-operations-demo.ts) in the Better Query examples.