---
title: Contributing to Better Query
description: A concise guide to contributing to Better Query
---

Thank you for your interest in contributing to Better Query! This guide is a concise guide to contributing to Better Query.

## Getting Started

Before diving in, here are a few important resources:

- Take a look at our existing <Link href="https://github.com/armelgeek/better-query/issues">issues</Link> and <Link href="https://github.com/armelgeek/better-query/pulls">pull requests</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/armelgeek/better-query
    ...
    <Step>
        ...
        git clone https://github.com/YOUR-USERNAME/better-query.git
        cd better-query
        ```
    </Step>
...
- Check our [GitHub issues](https://github.com/armelgeek/better-query/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/armelgeek/better-query/issues">issue</Link> with questions
