---
title: Contributing to Better Kit
description: A concise guide to contributing to Better Kit
---

Thank you for your interest in contributing to Better Kit! This guide is a concise guide to contributing to Better Kit.

## Getting Started

Before diving in, here are a few important resources:

- Take a look at our existing <Link href="https://github.com/armelgeek/better-kit/issues">issues</Link> and <Link href="https://github.com/armelgeek/better-kit/pulls">pull requests</Link>
- Join our community discussions in <Link href="https://discord.gg/armelgeek">Discord</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/armelgeek/better-kit
    ...
    <Step>
        ...
        git clone https://github.com/YOUR-USERNAME/better-kit.git
        cd better-kit
        ```
    </Step>
...
- Check our [GitHub issues](https://github.com/armelgeek/better-kit/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/armelgeek/better-kit/issues">issue</Link> with questions
- Join our <Link href="https://discord.gg/armelgeek">community discussions</Link>
