...
/**
 * Admin configuration for server-side operations and metadata.
 *
 * This configuration defines resources, permissions, and UI metadata
 * for the admin panel. While not currently used in client components,
 * it serves as the source of truth for:
 * - Resource definitions and schemas
 * - Field metadata and display options
 * - Permission rules and access control
 * - Navigation and menu structure
 *
 * For client-side operations, use adminClient from './admin-client.ts'
 */
